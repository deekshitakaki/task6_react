                                        ...
                                        <div class="row text-light">
                                            <div class="col-6 text-center">
                                                <div class="about-info mt-5">
                                                    <p><span className="fs-2"> Deekshita</span></p>
                                                    <p><span className="fs-4">Full stack developer</span></p>
                                                    <p><span>@deekshitakaki</span></p>
                                            ...
                                            <div class="col-12 p-4">
                                                <div class="about-me pt-4 pt-md-0">
                                                    ...
                                                    <p>
                                                    A smart working junior year computer science student . 
Skilled in designing and also has hands on cyber security. Good at
 communication , friendly attitude and a fast learner . Seeking an entry
 level opportunity in a good company to utilize my skills and enhance
 learning in work field.I am a full stack web developer with experience in building responsive websites and applications using HTML, CSS, JavaScript, ReactJS and Bootstrap.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div className="container m-5">
                ...
                <div className="row">
                    <ul className="col-12 col-xxl-6 list-group mt-5 ps-4">
                        ...
                        <li className="list-group-item"><span className="fw-bold">Full Name:Kaki Deekshita </span></li>
                        <li className="list-group-item"><span className="fw-bold">Birthday:25th May </span></li>
                    ...
                    <ul className="col-12 col-xxl-6 list-group mt-5 pe-4">
                        <li className="list-group-item"><span className="fw-bold">Git Profile: </span><a className="link" href="https://github.com/deekshitakaki">Click Here</a></li>
